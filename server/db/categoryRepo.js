...
import redisClint  from '../connection/redisConnect'
...
const addCategory = async (CategoryName , Description)=>{
    ...
    //  output
    const newCatagory = {CategoryName:output[0].CategoryName, description :output[0].Description}
    
    // set the cashe and update 
    await redisClint.set(`categoryCache:${rows.insertId}`,
